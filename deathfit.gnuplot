...
# set output '../ma-deathfit-nolog-06-08.png'
unset clip points
set clip one
unset clip two
...
set xrange [ * : day_of_3 ] noreverse writeback
set arrow 1 from day_of_3-10,2 to day_of_3,3 lt 4
set label 99 "3 deaths/day" at day_of_3-10,2 right offset character 0,-0.5
